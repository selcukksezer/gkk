-- Migration: Explicit prison admission log for collect_facility_resources_v2
-- Adds an explicit RAISE LOG showing whether admission will occur (true/false)
...
BEGIN
    ...
    -- Determine whether admission will actually occur (no active prison record)
    ...
    -- Log the prison check and explicit admission decision for server logs
