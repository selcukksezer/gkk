...
-- DATABASE SCHEMA - TABLOLAR SADECE (Idempotent)
-- ================================================================================
-- Tarih: 2026-02-07
...
--   • Policy yapı oluşturur (mevcut policy DROP etmez)
--
...
-- ============================================================
-- 17. PUBLIC.CRAFTED_ITEMS_LOG (Üretilmiş Item Kayıdı)
-- ============================================================
...
-- ============================================================
-- 18. GAME.QUESTS (Görev Tanımları)
-- ============================================================
...
-- ============================================================
-- 19. GAME.USER_QUESTS (Oyuncu Görev İlerlemesi)
-- ============================================================
...
-- ============================================================
-- 20. GAME.DUNGEONS (Zindan Tanımları)
-- ============================================================
...
-- ============================================================
-- 21. GAME.DUNGEON_RUNS (Zindan Koşuları)
-- ============================================================
...
-- ============================================================
-- 22. GAME.ENHANCEMENT_HISTORY (Geliştirme Geçmişi)
-- ============================================================
...
-- ============================================================
-- 26. GAME.PURCHASES (Satın Almalar)
-- ============================================================
...
--                    crafted_items_log (15 tablo)
--   analytics     : analytics_events, analytics_daily_aggregates (2 tablo)
--   admin         : audit_logs, bans (2 tablo)
-- 
--   TOPLAM: 30 tablo + 4 schema
-- ============================================================
