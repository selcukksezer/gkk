-- Migration: Fix admit_to_prison to use auth_id and update correct prison field
-- Fixes two bugs: WHERE clause uses id instead of auth_id, and updates hospital_until instead of prison_until
